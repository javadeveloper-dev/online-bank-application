...
const baseUrlForUser = document.getElementById("baseUrlForUser").value;
...
async function saveRegistrationForm(formBody, event) {
	try {
		...
		var baseUrlForAdmin;
		if (document.getElementById("baseUrlForAdmin") !== null) {
			baseUrlForAdmin = document.getElementById("baseUrlForAdmin").value;
		}
		var baseUrlForUser
		if (document.getElementById("baseUrlForUser") !== null) {
			baseUrlForUser = document.getElementById("baseUrlForUser").value;
		}
		...
		if (registrationType === "Admin Registration") {
			url = `${baseUrlForAdmin}saveAdminRegistrationData`;
		} else {
		...
		console.log(saveRegistereData);
	    // for (let [key, value] of saveRegistereData.entries()) {
